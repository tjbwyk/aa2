...
def run_q_learning(learning_rate = 0.1, discount_factor = 0.9, epsilon=0.1, tau=0.1, value_init= 15, num_episodes=1000, verbose=True, policy_style="q-egreedy"):
    # Initialize env:
    field = Field(11, 11)
    ...
    for i in range(1,num_episodes):
        ...
        while not field.is_ended():
            action = policy.pick_next_action(cur_state, style=policy_style,epsilon=epsilon,tau=tau)
