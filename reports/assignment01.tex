...
\end{figure}
\section{Conclusion}
We have implemented the first 4 sub-assignments as explained in the assignment description. The relative position assignments was considered, but implementation was later removed due to time constraints. We plan on implementing this before delving into Assignment 2 however.

\todo{Reflect on differences between policy iteration and value iteration}
