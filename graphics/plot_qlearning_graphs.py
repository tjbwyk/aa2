...
if __name__ == '__main__':
    ...
    plt.savefig("reports/qlearning_lr%s_df%s_eps%s_valueinit%s_num_eps%s.pdf" % str_arg_list, bbox_inches='tight',interpolate=True)
    plt.savefig("reports/qlearning_lr%s_df%s_eps%s_valueinit%s_num_eps%s.png" % str_arg_list, bbox_inches='tight',interpolate=True)
    print "Done."